...
return [
    ...
    'forms' => [
        ...
        'user' => [
            ...
            'teacher_link_hint' => 'Apar DOAR fișele fără cont (o fișă = un singur cont). Fișele se creează în secțiunea Profesori; contul capătă clasele și disciplinele fișei legate — fără fișă, catalogul rămâne gol.',
            'student_link' => 'Fișa de elev',
            'student_link_hint' => 'Apar DOAR fișele fără cont (o fișă = un singur cont), cu clasa curentă în etichetă. Fișa se creează în secțiunea Elevi, iar clasa ei vine din Înmatriculări.',
