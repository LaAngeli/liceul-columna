...
return [
    ...
    'forms' => [
        ...
        'user' => [
            ...
            'teacher_link_hint' => 'ONLY records without an account appear (one record = one account). Records are created in the Teachers section; the account gets the linked record\'s classes and subjects — without one, the catalog stays empty.',
            'student_link' => 'Student record',
            'student_link_hint' => 'ONLY records without an account appear (one record = one account), with the current class in the label. The record is created in the Students section, and its class comes from Enrollments.',
