@php
    ...
    /* preferred_time = ISO compact (din VisitScheduler). Cererile fără dată → null. */
    $visit = null;
...
<x-mail::message>
# {{ __('admission_mail.confirmation.heading', ['name' => $admission->parent_name]) }}

{{ $isVisit ? __('admission_mail.confirmation.intro_visit') : __('admission_mail.confirmation.intro_enrollment') }}

{{ __('admission_mail.confirmation.summary') }}
...
{{ __('admission_mail.confirmation.urgent', ['phone' => config('contact.phone')]) }}
